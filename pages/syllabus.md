...
*Learning assessments* are designed to demonstrate your mastery of the courses naturally measurable learning goals.  You may only discuss these deliverables with the course staff.  These deliverables are checked for both correctness and appropriate design.  Learning assessments will come in at least two different forms: Weekly in-class quizzes (on Fridays) and regular take-home examinations (distributed on Mondays and due on Tuesdays at {{ site.evening_due_time }}).
...
* You miss three or more days of classes in a row (for any reason).
...
If you are even unsure about whether you are seeking the "right" kind of help, ask yourself: **Am I getting help in a way that supports my learning?** Or does it undermine my learning to get correct answers faster?
...
> You can complete that LA in one of the following SoLAs. To lower your workload for the SoLAs, you should try to earn an S on as many in-class LAs as possible.
