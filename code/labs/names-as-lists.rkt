...
(define name-prefix (cut (list-ref <> 0)))
(define name-given (cut (list-ref <> 1)))
(define name-middle (cut (list-ref <> 2)))
(define name-family (cut (list-ref <> 3)))
(define name-suffix (cut (list-ref <> 4)))
