...
;;;   A variety of procedures that transform images, created for
;;;   assessment 3 in CSC-151-XX, Fall 2024.
;;;
...
;;; Acknowledgements:
;;; 
;;; * Starter code provided by Leah and PM.  That code includes 
...
;;; kitten-url : string?
;;; The URL of the kitten image used throughout the write-up
(define kitten-url
  "https://scamper.cs.grinnell.edu/images/kitten.jpg")

; -------------------------------------------------------------------
(problem "Part one: RGB-based transformations")
...
;;; ???
(define extreme
  (section pixel-map rgb-extreme _))
...
(define enhance-dominance
  (section pixel-map rgb-enhance-dominance _))
...
; -------------------------------------------------------------------
(problem "Part two: HSV-based transformations")
...
(description "kitten-rgb-transformed-01.jpg")
; Insert code to create kitten-rgb-transformed-01.jpg here!

(description "kitten-rgb-transformed-02.jpg")
; Insert code to create kitten-rgb-transformed-02.jpg here!

(description "kitten-rgb-transformed-03.jpg")
; Insert code to create kitten-rgb-transformed-03.jpg here!

(description "kitten-hsv-transformed-01.jpg")
; Insert code to create kitten-hsv-transformed-01.jpg here!

(description "kitten-hsv-transformed-02.jpg")
; Insert code to create kitten-hsv-transformed-02.jpg here!

(description "kitten-hsv-transformed-03.jpg")
; Insert code to create kitten-hsv-transformed-03.jpg here!
