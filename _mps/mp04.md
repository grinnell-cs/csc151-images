...
**Warning!** This MP is still in draft form.  It will evolve.  However, the only anticipated changes are additional examples (and the forthcoming rubric), so you can feel free to start (and even finish).
