...
![The kitten, looking a bit darker, with some ragged edges to the left and its eyes terrifyingly black.](../images/kitten-cyclic-subtract-32.jpg)
> (pixel-map (cut (rgb-cyclic-subtract <> (rgb 128 128 128))) kitten)
![The kitten, I suppose. The carpet is now a very pale green. Most of the kitten seems inverted into shades of grey. The cat is green and blue for some unknown reason.](../images/kitten-cyclic-subtract-128)
> (pixel-map (cut (rgb-cyclic-add <> (rgb 128 128 128))) kitten)
![The same image as the immediate previous one.](../images/kitten-cyclic-add-128)
```
